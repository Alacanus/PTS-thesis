...
?>
<img src="..\..\Writable\php_8_released.png" alt="" width="500" height="333">
...
<form id="form" action="createClass4.php" method="post" >
<h2>Upload and display Picture and Image</h2>
      <label for="fileToUpload">Image  - not working yet<div class="reqcolor">*</div></label>
